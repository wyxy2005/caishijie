...
//                    ToastUtils.showToast(mContext,entrance.itemTitle + position);
                    switch (position){
                        case 0:
                            ...
                            break;
                        case 1:
                            mContext.startActivity(new Intent(mContext,WeatherMoreActivity.class));
                            break;
                        case 2:
                            mContext.startActivity(new Intent(mContext,RobotKotlinActivity.class));
                            break;
                        case 3:
                            mContext.startActivity(new Intent(mContext,IpToolsActivity.class));
                            break;
                        case 4:
                            mContext.startActivity(new Intent(mContext,AboutAppActivity.class));
                            break;
                        case 5:
                            mContext.startActivity(new Intent(mContext,LogisticsDetailActivity.class));
                            break;
                    }
